...
export class GetLocationService {
  ...
  public cities: any = {};
    ...
    console.log(currency,country,"kjgfjuh");
      this.cities =  this.http.get(`http://partners.api.skyscanner.net/apiservices/autosuggest/v1.0/${country}/${currency}/en-GB/?query=stockholm&apiKey=lo963355623698263789439888313183`);
